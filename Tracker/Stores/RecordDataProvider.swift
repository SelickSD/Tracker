...
final class RecordDataProvider: DataProviderProtocol {
    ...
    private let dataStore: RecordDataStore


    init(_ dataStore: RecordDataStore, delegate: DataProviderDelegate) throws {
